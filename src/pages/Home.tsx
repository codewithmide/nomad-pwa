  ...
  return (
    <main className="h-screen w-screen flex-col flex bg-black p-5 text-white">
      ...
      <div className="w-full gap-6 between mt-[1rem]">
        ...
        <Link to="/receive" className='w-full text-center bg-white text-black p-3 font-medium'>
          Recieve
        </Link>
      </div>
      ...
      <div className='center w-full flex-col mt-[6rem]'>
        <div className='between w-full'>
          ...
          <Link to="/transactions" className='text-gray-400 font-regular text-sm'>show all</Link>
        </div>
        <div className='text-[.7rem] w-full text-left font-regular mt-4'>You currently have no tranasction</div>
      </div>
    </main>
  );
}